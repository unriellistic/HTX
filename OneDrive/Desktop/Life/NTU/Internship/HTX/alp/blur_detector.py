"""
This is the original script to test whether an image is blur or not.
"""
...
def detect_blur_fft(image, size=60, thresh=10, vis=False):
	...
	if vis:
		...
		ax[2].imshow(magnitude_reduced, cmap="gray")
	...
	# To compare the original image vs transformed
	...
	# display the magnitude image
	ax[1].imshow(magnitude, cmap="gray")
	ax[1].set_title("Inversed image after zero-out center")
	ax[1].set_xticks([])
	ax[1].set_yticks([])
	plt.show()
