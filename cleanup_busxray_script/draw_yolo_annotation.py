"""
A script to check if the xml2yolo works as intended. Plots the annotation on the image.
"""
...
def draw_box_on_image(image_path, txt_path):
    """
...
draw_box_on_image(image_path=image_filename, txt_path=label_filename)
