...
if __name__ == '__main__':
    ...
    parser.add_argument("--display-path", help="path to display a single image file", required=False, default=r"C:\Users\User1\Desktop\alp\cleanup_busxray_script\example.jpg")
